...
{
$cimage=$_FILES["img5"]["name"];
$id=intval($_GET['imgid']);
move_uploaded_file($_FILES["img5"]["tmp_name"],"img/carimages/".$_FILES["img5"]["name"]);
$sql="update cars set car_img5=:cimage where car_id=:id";
...
<head>
	...
	<title>DEU RAC | Admin Update Image 5</title>
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT car_img5 from cars where car_id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();

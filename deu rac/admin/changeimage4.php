...
{
$cimage=$_FILES["img4"]["name"];
$id=intval($_GET['imgid']);
move_uploaded_file($_FILES["img4"]["tmp_name"],"img/carimages/".$_FILES["img4"]["name"]);
$sql="update cars set car_img4=:cimage where car_id=:id";
...
<?php 
$id=intval($_GET['imgid']);
$sql ="SELECT car_img4 from cars where car_id=:id";
$query = $dbh -> prepare($sql);
$query-> bindParam(':id', $id, PDO::PARAM_STR);
$query->execute();
...
<div class="col-sm-8">
<img src="img/carimages/<?php echo htmlentities($result->car_img4);?>" width="300" height="200" style="border:solid 1px #000">
</div>
<?php }}?>
</div>
